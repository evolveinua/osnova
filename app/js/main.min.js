...
window.onload=function(){'use strict';var searchButton=void 0;var searchForm=void 0;var seacrhVisible=false;searchButton=document.getElementById('search');searchForm=document.getElementById('searchForm');searchButton.addEventListener('click',function(){if(!seacrhVisible){searchForm.removeAttribute('class','_display-none');searchForm.setAttribute('class','search-form');seacrhVisible=true;}else if(seacrhVisible){searchForm.setAttribute('class','_display-none');seacrhVisible=false;}},false);var zayavkaButton=void 0;var zayavkaForm=void 0;var zayavkaVisible=false;zayavkaButton=document.getElementById('zayavka');zayavkaForm=document.getElementById('zayavkaForm');zayavkaButton.addEventListener('click',function(){if(!zayavkaVisible){zayavkaForm.removeAttribute('class','_display-none');zayavkaForm.setAttribute('class','zayavka-wrap');zayavkaVisible=true;}else if(zayavkaVisible){zayavkaForm.setAttribute('class','_display-none');zayavkaVisible=false;}},false);var formOpen=void 0,formMainId=void 0,formVisible=false;formOpen=document.getElementById('formOpen');formMainId=document.getElementById('formID');formOpen.addEventListener('click',function(){if(!formVisible){formMainId.removeAttribute('class','_display-none');formMainId.setAttribute('class','call-wrapper');formVisible=true;}else if(formVisible){formMainId.setAttribute('class','_display-none');formVisible=false;}},false);var bottomSlider=document.getElementById('bottom-slider');if(bottomSlider){(function(){console.log('Есть недавно просмотренные товары');var tempSlider=$(bottomSlider).owlCarousel({items:3,itemsCustom:false,itemsDesktop:[1199,3],itemsDesktopSmall:[980,3],itemsTablet:[768,2],itemsTabletSmall:false,itemsMobile:[479,1],singleItem:false,itemsScaleUp:false,slideSpeed:200,paginationSpeed:800,rewindSpeed:1000,autoPlay:true,stopOnHover:true,navigation:false,navigationText:["prev","next"],rewindNav:true,scrollPerPage:false,pagination:false,paginationNumbers:false,responsive:true,responsiveRefreshRate:200,responsiveBaseWidth:window});var owl=tempSlider.data('owlCarousel');document.getElementById('acii-slider-left').addEventListener('click',function(){owl.prev();});document.getElementById('acii-slider-right').addEventListener('click',function(){owl.next();});})();}
var bottomSliderMain=document.getElementById('bottom-slider-main');if(bottomSliderMain){(function(){console.log('Есть недавно просмотренные товары');var tempSlider=$(bottomSliderMain).owlCarousel({items:4,itemsCustom:false,itemsDesktop:[1199,4],itemsDesktopSmall:[980,4],itemsTablet:[768,4],itemsTabletSmall:false,itemsMobile:[479,4],singleItem:false,itemsScaleUp:false,slideSpeed:200,paginationSpeed:800,rewindSpeed:1000,autoPlay:true,stopOnHover:true,navigation:false,navigationText:["prev","next"],rewindNav:true,scrollPerPage:false,pagination:false,paginationNumbers:false,responsive:true,responsiveRefreshRate:200,responsiveBaseWidth:window});var owl=tempSlider.data('owlCarousel');document.getElementById('bottom-slider-left').addEventListener('click',function(){owl.prev();});document.getElementById('bottom-slider-right').addEventListener('click',function(){owl.next();});})();}
var vendors=document.getElementById('vendors');if(vendors){(function(){console.log('Есть недавно просмотренные товары');var tempSlider=$(vendors).owlCarousel({items:5,itemsCustom:false,itemsDesktop:[1199,5],itemsDesktopSmall:[980,5],itemsTablet:[768,2],itemsTabletSmall:false,itemsMobile:[479,1],singleItem:false,itemsScaleUp:false,slideSpeed:200,paginationSpeed:800,rewindSpeed:1000,autoPlay:true,stopOnHover:true,navigation:false,navigationText:["prev","next"],rewindNav:true,scrollPerPage:false,pagination:false,paginationNumbers:false,responsive:true,responsiveRefreshRate:200,responsiveBaseWidth:window});var owl=tempSlider.data('owlCarousel');document.getElementById('vendors-left').addEventListener('click',function(){owl.prev();});document.getElementById('vendors-right').addEventListener('click',function(){owl.next();});})();}
var cats=document.getElementById('dropside');var CategoryMenu=function(){function CategoryMenu(element){_classCallCheck(this,CategoryMenu);this.overlay=document.getElementById('overlay');this.menu=document.getElementById('nav-categoryes');this.overlay.addEventListener('click',this.toggleCategoryMenu.bind(this));element.addEventListener('click',this.toggleCategoryMenu.bind(this));}
_createClass(CategoryMenu,[{key:'toggleOverlay',value:function toggleOverlay(){this.overlay.classList.toggle('overlay_show');}},{key:'toggleMenu',value:function toggleMenu(){this.menu.classList.toggle('nav-categoryes_show');}},{key:'toggleScrolLock',value:function toggleScrolLock(){document.querySelector('body').classList.toggle('body_lock');}},{key:'toggleCategoryMenu',value:function toggleCategoryMenu(){this.toggleScrolLock();this.toggleOverlay();this.toggleMenu();}}]);return CategoryMenu;}();var b=new CategoryMenu(cats);var childCatBtn=document.getElementById('tree-cat');var childCat=document.getElementById('cat-tree');var hiden=true;childCatBtn.addEventListener('click',function(){if(hiden){childCat.style.display='block';hiden=!hiden;}else{childCat.style.display='none';hiden=!hiden;}},false);};
